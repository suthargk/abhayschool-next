...
function TeacherGalleryFilters({ filters, pageSize, defaultPageSize, onPendingChange }) {
  ...
  function navigate(overrides) {
    ...
    startTransition(() => {
      router.push(qs ? `/teacher/gallery?${qs}` : "/teacher/gallery", { scroll: false });
    });
  }
...
export function TeacherGalleryList({
  initialItems,
  filters,
  hasAnyAlbums,
  page,
  ...
  async function confirmDelete() {
    ...
    try {
      await toast
        .promise(
          fetch(`/api/teacher/gallery/${id}`, { method: "DELETE" }).then((res) => {

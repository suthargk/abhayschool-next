  ...
  return (
    <TableRow ref={setNodeRef} style={style} className={cn(isDragging && "relative z-10 bg-muted")}>
      ...
      <TableCell className="font-medium">
        <Link
          href={`/super-admin/about-us/route-plan/${item.id}/edit`}
      ...
      <TableCell className="text-muted-foreground">
        ₹{item.rentPerYear.toLocaleString("en-IN")}
      </TableCell>
      <TableCell className="text-muted-foreground">{item.routeNo}</TableCell>
      <TableCell>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem asChild>
              <Link href={`/super-admin/about-us/route-plan/${item.id}/edit`}>Edit</Link>
            </DropdownMenuItem>
            {canPublish ? (
              <>
